//HintName: Testing.ParentClass.NestedTestAggregate.Core.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
	...
	partial class ParentClass
	{
		partial class NestedTestAggregate
		{
			...
			typeof(Purview.EventSourcing.Aggregates.Events.ForceSaveEvent),
				// Generated events
				typeof(Testing.ParentClass.TheBadger___Event),
			};

			System.String Purview.EventSourcing.Aggregates.IAggregate.AggregateType { get; } = "nested-test";
			...
			void Purview.EventSourcing.Aggregates.IAggregate.ApplyEvent(Purview.EventSourcing.Aggregates.Events.IEvent @event)
		{
			...
			else if (@event is Purview.EventSourcing.Aggregates.Events.ForceSaveEvent)
			{
				...
				else if (@event is Testing.ParentClass.TheBadger___Event)
				{
					ApplyStringValue((Testing.ParentClass.TheBadger___Event)@event);
				}
			}
