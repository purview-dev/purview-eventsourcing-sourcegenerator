//HintName: Testing.ParentClass.ParentClass2.TestAggregate.Core.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
	...
	partial class ParentClass
	{
		partial class ParentClass2
		{
			...
			typeof(Purview.EventSourcing.Aggregates.Events.ForceSaveEvent),
					// Generated events
					typeof(Testing.ParentClass.ParentClass2.TheBadger_EVENT),
				};
				...
				void Purview.EventSourcing.Aggregates.IAggregate.ApplyEvent(Purview.EventSourcing.Aggregates.Events.IEvent @event)
		{
			...
			else if (@event is Purview.EventSourcing.Aggregates.Events.ForceSaveEvent)
			{
				ApplySystemEvent((Purview.EventSourcing.Aggregates.Events.ForceSaveEvent)@event);
					...
					else if (@event is Testing.ParentClass.ParentClass2.TheBadger_EVENT)
					{
						ApplyStringValue((Testing.ParentClass.ParentClass2.TheBadger_EVENT)@event);
					}
				}
