//HintName: Testing.AdditionalEventsTestAggregate.Core.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Testing
{
	partial class AdditionalEventsTestAggregate
	{
		...
		readonly System.Collections.Generic.List<System.Type> _eventTypes = new System.Collections.Generic.List<System.Type>() {
			...
			// Generated events
			typeof(Testing.StringValueEvent),
		};

		System.String Purview.EventSourcing.Aggregates.IAggregate.AggregateType { get; } = "additional-events-test";
		...
		void Purview.EventSourcing.Aggregates.IAggregate.ApplyEvent(Purview.EventSourcing.Aggregates.Events.IEvent @event)
		{
			...
			else if (@event is Testing.StringValueEvent)
			{
				ApplyStringValue((Testing.StringValueEvent)@event);
			}
		}
